...
import { apparelCategoryMapping, apparelMockProducts } from "@/lib/db";
...
export default function CategoryPage({ params }) {
  ...
  const { headerImage, products } = apparelMockProducts[category] || {};
  const categoryName = apparelCategoryMapping[category];
